...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton('💖🇮🇳✨ Made By ✨🇮🇳💖', url='https://t.me/valkyraemovies')]])
...
#   album_id = r.json()[0]["albumid"]
    ...
    buttons = [[
        InlineKeyboardButton("JOIN MOVIES", url="https://t.me/valkyraemoviesearch")
    ]]                           
